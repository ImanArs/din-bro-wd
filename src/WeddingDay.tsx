export const WeddingDay = () => {
  return (
    <div className='w-full py-5 flex flex-col gap-5 text-center text-lg relative mt-[40px]'>
      ...
      <p className="playfair text-[18px]">Если Вы получили эту ссылку, значит мы от чистого сердца и с большой любовью приглашаем Вас на самое важное событие для нашей семьи - День свадьбы, которое пройдет в ресторане «АТА» 09 января 2025 года</p>
